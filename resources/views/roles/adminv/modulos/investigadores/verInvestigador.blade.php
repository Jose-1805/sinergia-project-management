...
<form id="formInvestigadorS" class="col s12 m10"
      style="">
                        ...
                        <div class="contenidoDiv">
                            ...
                            <div class="input-field">
                                ...
                                <input type="number" id="Identidficacion" name="Identidficacion" maxlength="45"
                                       length="45" required="required" value="{{$datos->per_identificacion}}" readonly/>
                            </div>
                            ...
                            <div class="input-field">
                                ...
                                <input type="text" id="Nombres" name="Nombres" value="{{$datos->per_nombres}}"
                                       maxlength="45" length="45" required="required" readonly/>
                            </div>
                            ...
                            <div class="input-field">
                                ...
                                <input type="number" id="Telefono" name="Telefono"
                                       value="{{$datos->per_numero_telefono}}" maxlength="45" length="45" readonly/>
                            </div>
                            ...
                            <div class="input-field">
                                ...
                                <input type="number" id="Celular" name="Celular" value="{{$datos->per_numero_celular}}"
                                       maxlength="45" length="45" readonly/>
                            </div>
                            ...
                            <div class="selectize-dropdown">
                                ...
                                @if ( $datos->per_genero == 1)
                                <input type="text" id="Genero" name="Genero" value="Masculino"
                                       AUTOCOMPLETE="ON" maxlength="50"
                                       length="50" required="required" readonly
                                        />
                                @else
                                    <input type="text" id="Genero" name="Genero" value="Femenino"
                                           AUTOCOMPLETE="ON" maxlength="50"
                                           length="50" required="required" readonly
                                            />
                                @endif
                            ...
                            <div class="selectize-dropdown">
                                <label for="TipoDeEvaluador">Tipo de Investigador<i class="material-icons texto-rojo">star_rate</i></label>
                                <input type="text" id="TipoDeEvaluador" name="TipoDeEvaluador"
                                       value="{{$datos->inv_tipo}}" AUTOCOMPLETE="ON" maxlength="50"
                                       length="50" required="required" readonly
                                        />
    ...
    <center>
        ...
        <a id="actualizar" class="btn" href="/adminv/actualizar-investigador/{{$datos->idInv}}">ACTUALIZAR EVALUADOR</a>
    </center>
    <br/>
