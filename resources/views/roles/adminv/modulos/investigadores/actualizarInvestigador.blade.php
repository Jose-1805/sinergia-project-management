...
<form id="formActualizarInvestigador" class="col s12 m10"
      style="">

    <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
    <input type="hidden" value="{{$datos->idInv}}" name="investigador_id"/>
                        ...
                        <div class="contenidoDiv">
                            ...
                            <div class="input-field">
                                ...
                                <input type="number" id="Identidficacion" name="Identidficacion" maxlength="45"
                                       length="45"  value="{{$datos->per_identificacion}}"/>
                            </div>
    ...
    <center>
        ...
        <input type="submit" id="submit" class="btn" value="ACTUALIZAR INVESTIGADOR" />
    </center>
    <br/>
