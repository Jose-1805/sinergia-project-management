...
<div id="opcionesProyectoAprobado" class="modal" style="margin-top: 100px;">
    ...
    <div class="modal-footer" style="background-color: #FFFFFF;padding: 0px;">
        <div class="hide-on-med-and-down">
            ...
            <a class="waves-effect waves-orange btn-flat btnAsignarAprobado">Asignar <i class="mdi-action-assignment-ind"></i></a>
            <a class="waves-effect waves-orange btn-flat btnSugerirAprobado">Sugerir <i class="mdi-content-drafts"></i></a>
        </div>
    </div>
</div>
