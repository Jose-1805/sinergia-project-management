...
@include('plantillas/perfiles/aprobados')
  ...
  <div id="opcionesPerfilEnFormulacion" class="modal" style="margin-top: 100px;">
            ...
            <div class="hide-on-med-and-down">
                ...
                <a class="waves-effect waves-orange btn-flat btnAsignarEnFormulacion">asignar<i class="mdi-action-assignment-ind"></i></a>
            ...
            <div class="hide-on-large-only collection">
                ...
                <a class="waves-effect waves-orange collection-item btnAsignarEnFormulacion">asignar<i class="mdi-action-assignment-ind"></i></a>
