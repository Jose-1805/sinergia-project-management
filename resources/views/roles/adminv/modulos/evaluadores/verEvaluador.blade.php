...
<form id="formNuevoEvaluador" class="col s12 m10"
      style="">
                ...
                <div class="collapsible-body" style="display: block;">
                    <fieldset>
                        <div class="contenidoDiv">
                            ...
                            <div class="selectize-dropdown">
                                <label for="TipoDeEvaluador">Tipo de Evaluador<i class="material-icons texto-rojo">star_rate</i></label>
                                <input type="text" id="TipoDeEvaluador" name="TipoDeEvaluador"
                                       value="{{$datos->eva_tipo}}" AUTOCOMPLETE="ON" maxlength="50"
                                       length="50" required="required" readonly
                                        />
    ...
    <center>
        ...
        <a id="actualizar" class="btn" href="/adminv/actualizar-evaluador/{{$datos->idEva}}">ACTUALIZAR EVALUADOR</a>
    </center>
    <br/>
